                                        ...
                                        <form @submit.prevent="updateProfile">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="tel" class="form-control" v-model="profile.so_dien_thoai">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Ngày Sinh</label>
                                                    <input type="date" class="form-control" v-model="profile.ngay_sinh">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    <label class="form-label">Địa Chỉ</label>
                                                    <textarea class="form-control" v-model="profile.dia_chi" rows="2"></textarea>
                                                </div>
                                            </div>
