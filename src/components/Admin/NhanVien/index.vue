                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    ...
                    <button
                      ...
                      v-on:click="Object.assign(edit_nhan_vien, v)"
                    >
                      Cập nhật
                    </button>
                    <button
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.ho_va_ten"
                type="text"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.email"
                type="email"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.ngay_sinh"
                type="date"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.so_dien_thoai"
                type="text"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.password"
                type="password"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.dia_chi"
                type="text"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              ...
              <input
                v-model="create_nhan_vien.luong_co_ban"
                type="number"
                class="form-control"
              />
            </div>
            <div class="mb-2">
              <label>Chức Vụ</label>
              <select
                v-model="create_nhan_vien.id_chuc_vu"
            ...
            <div class="mb-2">
              ...
              <select
                v-model="create_nhan_vien.id_phong_ban"
                class="form-control mt-2"
              >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2">
              <label class="form-label">Lương Cơ Bản</label>
              <input
                v-model="edit_nhan_vien.luong_co_ban"
                type="number"
                class="form-control"
              />
            </div>
            ...
            <div class="mb-2">
              <label>Phòng Ban</label>
              <select
                v-model="edit_nhan_vien.id_phong_ban"
                class="form-control mt-2"
              >
                <template v-for="(v, k) in list_phong_ban" :key="k">
                  <option v-bind:value="v.id">{{ v.ten_phong_ban }}</option>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <select
                  v-model="create_hop_dong.id_loai_hop_dong"
                  v-on:change="loadNoiDung()"
                  class="form-control"
                >
            ...
            <div class="row mt-2">
              <div class="col-lg-12">
                <!-- <textarea v-model="create_hop_dong.noi_dung" class="form-control" cols="30"
                                    rows="10"></textarea> -->
                <ckeditor
                  v-model="create_hop_dong.noi_dung"
                  :editor="editor"
                  :config="editorConfig"
                />
              </div>
            ...
            <div class="row mt-2">
              <div class="col-lg-4">
                ...
                <input
                  v-model="create_hop_dong.ngay_bat_dau"
                  type="date"
                  class="form-control"
                />
              </div>
              <div class="col-lg-4">
                ...
                <input
                  v-model="create_hop_dong.ngay_ket_thuc"
                  type="date"
                  class="form-control"
                />
              </div>
              <div class="col-lg-4">
                ...
                <input
                  v-model="create_hop_dong.ngay_ky"
                  type="date"
                  class="form-control"
                />
              </div>
