          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <select v-model="searchData.id_loai_vang" class="form-select">
                <option value="">Tất cả</option>
                <option v-for="lv in loaiVangList" :key="lv.id_loai_vang" :value="lv.id_loai_vang">
                  {{ lv.ten_loai_vang }}
                </option>
              </select>
            </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="createDangKyVang" data-bs-dismiss="modal">Lưu</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6 mb-3">
                <label class="form-label">Nhân viên</label>
                <select v-model="editItem.id_nhan_vien" class="form-select" required>
                  <option value="">-- Chọn nhân viên --</option>
                  <option v-for="nv in nhanVienList" :key="nv.id" :value="nv.id">
                    {{ nv.ho_va_ten }}
                  </option>
              ...
              <div class="col-md-6 mb-3">
                <label class="form-label">Loại vắng</label>
                <select v-model="editItem.id_loai_vang" class="form-select" required>
                  <option value="">-- Chọn loại vắng --</option>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
            <button type="button" class="btn btn-primary" @click="update" data-bs-dismiss="modal">Lưu</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    createDangKyVang() {
      axios.post('http://localhost:8000/api/admin/them-bao-cao-vang', this.formData, {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("tk_nhan_vien"),
        }
      })
    ...
    fetchDangkyVang() {
      axios.get('http://localhost:8000/api/admin/get-bao-cao-vang', {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("tk_nhan_vien"),
        }
      })
    ...
    update() {
      axios.put('http://localhost:8000/api/admin/sua-bao-cao-vang', this.editItem, {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("tk_nhan_vien"),
        }
      })
    ...
    xoaDangKyVang(id) {
      axios.delete('http://localhost:8000/api/admin/xoa-bao-cao-vang/' + id, {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("tk_nhan_vien"),
        }
      })
