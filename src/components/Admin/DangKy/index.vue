    ...
    <form @submit.prevent="dangKy">
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" id="ho_va_ten" v-model="formData.ho_va_ten" />
        </div>
        <div class="col-md-6 mb-3">
          <label for="ngay_sinh" class="form-label">Ngày sinh</label>
          <input type="date" class="form-control" id="ngay_sinh" v-model="formData.ngay_sinh" />
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="tel" class="form-control" id="so_dien_thoai" v-model="formData.so_dien_thoai" />
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="date" class="form-control" id="ngay_tuyen_dung" v-model="formData.ngay_tuyen_dung" />
        </div>
        <div class="col-md-6 mb-3">
          <label for="ma_vai_tro" class="form-label">Vai trò</label>
          <select class="form-select" id="ma_vai_tro" v-model="formData.id_vai_tro">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select" id="ma_phong_ban" v-model="formData.id_phong_ban">
        ...
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select" id="ma_chuc_danh" v-model="formData.id_chuc_danh">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select" id="loai_hop_dong" v-model="formData.loai_hop_dong">
